    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative pt-40 pb-28 lg:pt-52 lg:pb-40 text-center overflow-hidden bg-slate-950">
          ...
          <div className="absolute top-0 right-0 w-[30vw] h-[30vw] max-w-[500px] max-h-[500px] bg-[#EAB308]/30 rounded-bl-full z-0 pointer-events-none blur-3xl" />
          ...
          <div className="absolute inset-0 z-0">
            <img src={imgStory} alt="Solar Background" className="w-full h-full object-cover opacity-70" />
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-white">
            ...
            <ScrollReveal effect="fade-up" delay={0.25}>
              <p className="mt-8 text-xl lg:text-2xl text-white/80 leading-relaxed max-w-3xl mx-auto font-medium">
